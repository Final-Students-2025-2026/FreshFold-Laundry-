 ...
 *
 * For the one thing the padding above cannot express: a bottom safe-area inset
 * reserved *inside* the lifted content is dead space once the keyboard covers
 * that part of the screen, and leaving it in floats the content a navigation
